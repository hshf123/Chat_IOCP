...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::RoomInfo, id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::RoomInfo, playercount_),
  PROTOBUF_FIELD_OFFSET(::Protocol::RoomInfo, players_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::Player)},
  { 9, -1, -1, sizeof(::Protocol::RoomInfo)},
};
...
void Player::InternalSwap(Player* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Player, roomid_)
      + sizeof(Player::roomid_)
...
void RoomInfo::InternalSwap(RoomInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RoomInfo, playercount_)
      + sizeof(RoomInfo::playercount_)
