...
inline uint32_t Player::_internal_roomid() const {
  return roomid_;
}
inline uint32_t Player::roomid() const {
  // @@protoc_insertion_point(field_get:Protocol.Player.roomId)
  return _internal_roomid();
}
inline void Player::_internal_set_roomid(uint32_t value) {
  
  roomid_ = value;
}
inline void Player::set_roomid(uint32_t value) {
...
inline uint32_t RoomInfo::id() const {
  // @@protoc_insertion_point(field_get:Protocol.RoomInfo.id)
  return _internal_id();
}
...
inline void RoomInfo::set_id(uint32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:Protocol.RoomInfo.id)
}
...
inline uint32_t RoomInfo::_internal_playercount() const {
  return playercount_;
}
inline uint32_t RoomInfo::playercount() const {
  // @@protoc_insertion_point(field_get:Protocol.RoomInfo.playerCount)
  return _internal_playercount();
}
inline void RoomInfo::_internal_set_playercount(uint32_t value) {
  
  playercount_ = value;
}
inline void RoomInfo::set_playercount(uint32_t value) {
  _internal_set_playercount(value);
  // @@protoc_insertion_point(field_set:Protocol.RoomInfo.playerCount)
}
...
inline ::Protocol::Player* RoomInfo::mutable_players(int index) {
...
inline const ::Protocol::Player& RoomInfo::_internal_players(int index) const {
  return players_.Get(index);
}
inline const ::Protocol::Player& RoomInfo::players(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.RoomInfo.players)
  return _internal_players(index);
}
inline ::Protocol::Player* RoomInfo::_internal_add_players() {
  return players_.Add();
}
inline ::Protocol::Player* RoomInfo::add_players() {
